...
const sponsorResources = [
  createResource('Google Cloud', (
    <p className="text-left">
      Cloud Hero is a key opportunity for students to learn the fundamental tools and capabilities of
      Google Cloud, share an
      engaging experience, and experience virtual training with a little competition thrown in for fun.
      The game is made up of
      a virtual hands-on technical lab (<a target="_blank"
                                           href="https://slack-redir.net/link?url=https%3A%2F%2Fwww.qwiklabs.com%2F">Qwiklabs</a>)
      layered with activity-tracking and scoring. Earn Google Cloud badges to show
      your skills and expertise!
    </p>)),
  createResource('WolframAlpha',
    (
      <p className="text-left">
        Wolfram Research is pleased to sponsor your event by providing access to our latest technology,
        Wolfram|One!
        ...
        <br></br>
        <br></br>
        This URL will take you to a sign-in page and prompt you to log in using your Wolfram ID. If you
        don't already have
        a Wolfram ID, you'll be prompted to create one using an active email address. Once logged in, you
        will see in the
        Downloads section which platforms of the software you have access to, with their accompanying
        activation keys.
        ...
        <br></br>
        <a target="_blank"
           href="https://account.wolfram.com/products">https://account.wolfram.com/products</a>
        <br></br>
        <br></br>
        ...
        through
        post-docs. These programs are for those interested in programming, computational thinking, machine
        learning,
        and innovative tech. Students create and complete a unique project to publish during the program. To
        sign up
        for 2021 registration announcements visit:
        <br></br>
        <a target="_blank"
           href="http://education.wolfram.com/summer/">http://education.wolfram.com/summer/</a>
        <br></br>
        <br></br>
        Interested in Wolfram mentorships or internships? Check out our opportunities here:
        <br></br>
        <a target="_blank"
           href="https://www.wolfram.com/company/careers">https://www.wolfram.com/company/careers</a>
        <br></br>
        <br></br>
  ...
  createResource('MLH Software',
    (
      <p className="text-left">
        MLH has partnered with some amazing technology companies to get you FREE access to their APIs this
        weekend.
        ...
        <ul className="ml-4" style={{ listStyleType: 'disc' }}>
          <li className="mt-4">
            ...
            <br></br>
            Bring your project to the next level using Google Cloud Platform's infinitely scalable virtual
            machines,
          ...
          <li className="mt-4">
            ...
            &nbsp;
            The GitHub Student Developer Pack gives hackers free access to the best developer tools, all in
            one place.
            <br></br>
          ...
          <li className="mt-4">
            ...
            <br></br>
            Domain.com provides all the domain services you need from registration to hosting to SSL
            certificates & beyond.
          </li>
          <li className="mt-4">
            <u>
...
const freeResources = [
  createResource('MOOC Platforms',
    (
      <p className="text-left">
        ...
        <br></br>
        <br></br>
        <strong>Note:&nbsp;</strong>Most of these platforms have free courses. Also, most universities have
        partnerships for the
        premium version of some or all of these platforms. These are very helpful and you should check with
        your University
        for access to them.
        ...
        <ul className="ml-4" style={{ listStyleType: 'disc' }}>
          ...
          <li className="mt-4">
            ...
            to more than
            20 million learners, the majority of top-ranked universities in the world and industry-leading
            companies.
            As a global nonprofit, edX is transforming traditional education, removing the barriers of cost,
            location and access.
          ...
          <li className="mt-4">
            ...
            &nbsp;
            We give you temporary credentials to Google Cloud Platform and Amazon Web Services, so you can
            learn the cloud using the real
            thing – no simulations. From 30-minute individual labs to multi-day courses, from introductory
            level to expert,
            instructor-led or self-paced, with topics like machine learning, security, infrastructure, app
            dev, and more, we've got you covered.
          </li>
          ...
          <li className="mt-4">
            ...
            &nbsp;
            Organizations need individuals with cloud skills to help transform their business. AWS Training
          ...
          <li className="mt-4">
            ...
            &nbsp;
            Learn more about Conversational AI, AI Services, Machine Learning, Autonomous Systems,
            Responsible AI and more.
          </li>
        </ul>
      </p>
    )),
  createResource('Coding Starter Kits', (
    <p className="text-left">
      <strong><u>
        Build Your Own:
      </u></strong>
      ...
      project started:
      decide on what to build, pick a programming language, pick a web framework, pick a CSS framework. A
      while later,
      you might have an initial project up on GitHub and only then can other team members start
      contributing. Or how about
      doing something as simple as Sign in with Facebook authentication? You can spend hours on it if you
      are not familiar
      ...
      as possible to cover most use cases of hackathon web apps, without being too specific. In the worst
      case, you can use this
      as a learning guide for your projects, if for example you are only interested in Sign in with Google
  ...
  createResource('Software Resources', (
    <p className="text-left">
      Will add later.
    </p>
  ))
