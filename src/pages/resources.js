...
export default () => {
  const resources = ["google cloud", "Wolfram alpha", "balsamiq", "echoar", "twilio", "MLH Software"];
  const f_resources = ["mooc paltforms", "coding starter kits", "api resources", "software resources"]
  const [ res_sel, show_res] = useState("");
  return (
    <Layout>
      <SEO />
          ...
          <div className="flex mb-4">
            <div className="w-2/5">
              ...
              <ul className="ml-4"></ul>
                {/* <button onClick={()=>b.operation()}>click here</button> */}
                {resources.map(resource => (
                  <li
                    key={resource}
                    onClick={() => show_res(resource)}
            ...
            <div className="w-3/5">
              <p>
                {res_sel === "" && <h2> Click on a resource to get started! </h2>}
                  {res_sel === "google cloud" && <Card className="mx-4 bg-white text-black text-center">
      <div>
        ...
        <p className="text-left">
          ...
          your skills and expertise!
                  ...
                  {res_sel === "Wolfram alpha" &&  <Card className="mx-4 bg-white text-black text-center">
    <h1 className="text-2xl font-semibold">
   ...
   <p className="text-left">
     ...
     Good luck, and happy hacking!
                  ...
                  {res_sel === "balsamiq" &&   <Card className="mx-4 bg-white text-black text-center">
   <h1 className="text-2xl font-semibold">
     Balsamiq Resources
   </h1>
   <p className="text-left">
     ...
     <a target="_blank" href="https://support.balsamiq.com/sales/cloudpromo/">Instructions for promo code redemption</a>
                  ...
                  {res_sel === "echoar" &&   <Card className="mx-4 bg-white text-black text-center">
   <h1 className="text-2xl font-semibold">
     echoAR Resources
   </h1>
   <p className="text-left">
  ...
  {res_sel === "mooc platforms" &&     <Card className="mx-4 bg-white text-black text-center">
   <h1 className="text-2xl font-semibold">
  ...
  {res_sel === "coding starter kits" &&    <Card className="mx-4 bg-white text-black text-center">
   <h1 className="text-2xl font-semibold">
     Coding Starter Kits
   </h1>
   <p className="text-left">
  ...
  {res_sel === "api resources" &&     <Card className="mx-4 bg-white text-black text-center">
   <h1 className="text-2xl font-semibold">
     API Resources
   </h1>
   <p className="text-left">
  ...
  {res_sel === "software resources" &&     <Card className="mx-4 bg-white text-black text-center">
   <h1 className="text-2xl font-semibold">
     Software Resources
   </h1>
   <p className="text-left">
